...
export const Navbar = ({ children, className }) => {
  ...
  return (
    <motion.div
      ...
      className={cn('sticky inset-x-0 top-0 md:top-3 z-40 w-full', className)}
    >
...
export const NavItems = ({ items, className, onItemClick }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2 font-medium',
        className
      )}
    >
      {items.map((item, idx) => (
...
export const NavbarToggleThemeButton = () => {
...
export const ThemeToggler = ({
  ...
  const baseStyles =
    'button relative cursor-pointer transition duration-200 inline-block text-center';
